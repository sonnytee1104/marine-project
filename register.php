...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/ani-loca.css" />
    <link rel="stylesheet" href="assets/css/categories.css" />
    <link rel="stylesheet" href="assets/css/details.css" />
    <link rel="stylesheet" href="register.css" />
    <link rel="preload" as="image" href="assets/img/main-banner.png" />
    <link rel="preload" as="image" href="assets/img/preloader.svg" />
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
      href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&display=swap"
      ...
      <div class="container">
        ...
        <nav class="navbar" data-navbar="">
          ...
          <ul class="navbar-list">
            ...
            <li class="navbar-item">
              <a href="<?= ROOT_URL?>categories.php" class="navbar-link"
                >Sea Life</a
              >
            </li>

            <li class="navbar-item">
              <a href="<?= ROOT_URL?>contact-us.php" class="navbar-link"
                >Contact</a
              >
            </li>
          </ul>
          ...
          <div class="header-action">
            <a href="#" class="login-btn"
              ><button class="login-popup">Login</button></a
            >

            <a href="<?= ROOT_URL?>register.php" class="btn btn-primary"
              >Sign Up</a
            >
          </div>
        </nav>
